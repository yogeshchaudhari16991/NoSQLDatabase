...
namespace Project2Starter
{
    public class QueryPredicate
    {
        ...
        */
        public void key_value_search(DBEngine<string, DBElement<string, List<string>>> db, IQuery<string, DBElement<string, List<string>>> i_query, QueryEngine<string, DBElement<string, List<string>>> qe )
        {
            "Query for value with specified key (key = element2):".title();
            WriteLine();
            string key_to_search = "element2";
        ...
        */
        public void key_children_search(DBEngine<string, DBElement<string, List<string>>> db, IQuery<string, DBElement<string, List<string>>> i_query, QueryEngine<string, DBElement<string, List<string>>> qe)
        {
            string specific_key = "element2";
        ...
        */
        public void pattern_matching(DBEngine<string, DBElement<string, List<string>>> db, IQuery<string, DBElement<string, List<string>>> i_query, QueryEngine<string, DBElement<string, List<string>>> qe)
        {
            string pattern = "element123";
        ...
        */
        public void default_pattern_matching(DBEngine<string, DBElement<string, List<string>>> db, IQuery<string, DBElement<string, List<string>>> i_query, QueryEngine<string, DBElement<string, List<string>>> qe)
        {
            string pattern = "";
        ...
        */
        public void metadata_string(DBEngine<string, DBElement<string, List<string>>> db, IQuery<string, DBElement<string, List<string>>> i_query, QueryEngine<string, DBElement<string, List<string>>> qe)
        {
        ...
        *  time-interval
        */ 
        public void default_date_time_specific(DBEngine<string, DBElement<string, List<string>>> db, IQuery<string, DBElement<string, List<string>>> i_query, QueryEngine<string, DBElement<string, List<string>>> qe)
        {
        ...
        */
        public void date_time_specific(DBEngine<string, DBElement<string, List<string>>> db, IQuery<string, DBElement<string, List<string>>> i_query, QueryEngine<string, DBElement<string, List<string>>> qe)
        {
