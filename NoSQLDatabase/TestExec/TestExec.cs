...
namespace Project2Starter
{
  class TestExec
  {
    ...
    void TestR5()
    {
      ...
      enum_db.create_xml_from_db(false);
    ...
    private void schedular<Key, Data>(DBEngine<Key, DBElement<Key, Data>> db)
    {
      Schedular<Key, Data> td = new Schedular<Key, Data>(db);
    ...
    void TestR7()
    {
      ...
      qp.key_value_search(enum_db, i_query, qe);
      WriteLine();
      qp.key_children_search(enum_db, i_query, qe);
      WriteLine();
      qp.pattern_matching(enum_db, i_query, qe);
      WriteLine();
      qp.default_pattern_matching(enum_db, i_query, qe);
      WriteLine();
      qp.metadata_string(enum_db, i_query, qe);
      WriteLine();
      qp.date_time_specific(enum_db, i_query, qe);
      WriteLine();
      qp.default_date_time_specific(enum_db, i_query, qe);
      WriteLine();
    }
    void TestR8()
    {
